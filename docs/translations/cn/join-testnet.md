...
::: 提示 当前测试网
请查看[testnet repo](https://github.com/cosmos/testnets)获取最新的公共测试网信息，包含了所使用的 OKChain-SDK 的正确版本和 genesis 文件。
:::

::: 警告
你需要先完成[安装`okchain`](./installation.md)
:::
...
获取测试网的信息，包括 OKChain-SDK 正确的版本和 genesis 文件。
...
注意这里我们使用的是包含最新稳定发布版本的`master`分支。请查看[testnet repo](https://github.com/cosmos/testnets)查看哪个版本的测试网需要哪一个 OKChain-SDK 版本，在[SDK 发布版](https://github.com/cosmos/cosmos-sdk/releases)中对应的详细信息。
